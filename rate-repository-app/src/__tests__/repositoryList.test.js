...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        expect(screen.getByTestId('https://avatars1.githubusercontent.com/u/54310907?v=4')).toBeDefined();
        expect(screen.getByText('Flexible promise-based React data loader')).toBeDefined();
        expect(screen.getByText('JavaScript')).toBeDefined();
        expect(screen.getByText('Flexible promise-based React data loader')).toBeDefined();
        expect(screen.getByTestId('https://avatars2.githubusercontent.com/u/4060187?v=4')).toBeDefined();
      });
    });
  });